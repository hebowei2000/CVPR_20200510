...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.stage1_cfg = {'NUM_MODULES': 1, 'NUM_RANCHES': 1, 'BLOCK': 'BOTTLENECK',
        ...
        self.stage5_cfg = {'NUM_MODULES': 3, 'NUM_BRANCHES': 5, 'BLOCK': 'BASIC',
                           'NUM_BLOCKS': [4, 4, 4, 4, 4], 'NUM_CHANNELS': [48, 96, 192, 384, 768], 'FUSE_METHOD': 'SUM'}
        ...
        last_inp_channels = np.int(np.sum(pre_stage_channels) + 768)
    ...
    def forward(self, x):
        ...
        ppm = F.upsample(ppm, size=(x0_h, x0_w), mode='bilinear')
        x = torch.cat([x[0], x1, x2, x3, x4, ppm], 1)
